...
import { getCandidateProfile } from '@/services/candidate-service'
...
export default function JobDetails () {
    ...
    return (
      <div className='max-w-6xl py-4'>
        <div className='bg-white rounded-2xl p-6 shadow-sm border border-gray-200 text-center'>
          ...
          <Button onClick={() => router.push('/job-listings')}>
  ...
  return (
    <div className=' py-4'>
      {showResumeModal && <ChooseResume onClose={closeResumeModal} job={job} />}
